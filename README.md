...
marketplaceScrapper is a simple web scraper designed to enhance search capabilities for the OLX website. It allows you to search and extract relevant information from the OLX platform using a given query, providing a basic foundation for a better search engine.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/puksh/marketplaceScrapper.git
   ```

2. Navigate into the project directory:

   ```bash
   cd marketplaceScrapper
   ```
